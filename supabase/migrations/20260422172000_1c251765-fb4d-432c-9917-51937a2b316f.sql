-- Update the get_dashboard_stats function to group by product_id
...
-- Clean up product names in products table
UPDATE products SET name = trim(name);

-- Clean up product names in sale_items table
UPDATE sale_items SET product_name = trim(product_name);
