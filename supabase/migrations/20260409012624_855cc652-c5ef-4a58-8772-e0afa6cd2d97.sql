CREATE OR REPLACE FUNCTION public.get_dashboard_stats(p_selected_year integer, p_selected_month integer, p_today date DEFAULT (now() AT TIME ZONE 'America/Sao_Paulo')::date)
 RETURNS jsonb
 LANGUAGE plpgsql
...
BEGIN
  ...
  -- Use Brazil timezone for "today" boundaries
