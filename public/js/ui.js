...
const UI = (() => {
  const ICONS = {
    ...
    whatsapp: '<path d="M20 11.5A8.5 8.5 0 0 1 7.4 18.6L4 20l1.5-3.3A8.5 8.5 0 1 1 20 11.5z"></path><path d="M9.2 8.6c.2-.5.3-.5.6-.5h.5c.2 0 .4.1.5.4l.7 1.7c.1.2 0 .4-.1.6l-.4.5c-.1.1-.1.3 0 .4.3.5.8 1 1.3 1.4.5.4 1 .8 1.6 1.1.1.1.3 0 .4-.1l.5-.4c.2-.1.4-.1.6 0l1.6.8c.3.1.4.3.4.5v.5c0 .3 0 .4-.5.6A6 6 0 0 1 12 17.2 5.2 5.2 0 0 1 8.6 9.5c0-.3.1-.4.6-.9z"></path>'
  };
